difference() {
  ...
  translate([54,10,36]) rotate([0,-45,0]) cube([20,40,5]);
}
...
translate([58,-48,18]) rotate([0,90,0]) difference() {
        translate([20,50,0]) rotate([fanangle,0,0]) union() {
                difference () {
                        translate([0,5,0]) cube([40,45,5.6]);
                ...
                translate([20,28,0]) mirror([0,0,-1]) difference() {
                        ...
                        hull() {
                                ...
                                translate([0,-5,nozzlelength]) rotate([-angle,0,0]) cylinder(r=opening+2,h=0.01);
                        }
                        translate([0,0,-0.1]) hull() {
                                cylinder(r=18,h=0.01);
                                translate([0,-5,nozzlelength+0.2]) rotate([-angle,0,0]) cylinder(r=opening,h=0.01);
                        }
                }
        }
